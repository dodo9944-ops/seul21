...
(function() {
  ...
  style.textContent = `
    ...
    @media(max-width:768px) {
      #seul-chatbot { bottom:calc(50px + env(safe-area-inset-bottom, 0px)); right:10px; }
      #chat-toggle { height:30px; padding:0 8px 0 7px; border-radius:15px; gap:4px; opacity:0.75; }
