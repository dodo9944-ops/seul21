...
const MOCK = {
  ...
  /* ──────────────────────────── 업무실적 ──────────────────────────── */
  portfolio: [
    { id:'pf1', name:'한남3구역 주택재개발 정비사업', type:'재개발', district:'용산구', status:'진행중', year:'2026', scale:'5,816세대', role:'정비사업전문관리',
      ...
      tasks:['사업시행인가 지원','관리처분계획 수립 지원','조합원 분양설계서 작성','시공사 선정 자문 및 입찰 관리','총회·이사회 운영 지원','한강변 경관심의 대응','갈등관리 및 민원 대응','사업성 분석 및 검토'],
    ...
    { id:'pf2', name:'흑석9구역 주택재개발 정비사업', type:'재개발', district:'동작구', status:'진행중', year:'2025', scale:'3,446세대', role:'정비사업전문관리',
      ...
      tasks:['조합설립인가 지원','사업시행인가 행정 절차 대응','시공사 선정 입찰 관리','관리처분계획 수립 지원','분양가 산정 및 분양설계 검토','총회 운영 및 의사결정 지원','민원·갈등 관리'],
    ...
    { id:'pf5', name:'은마아파트 재건축 추진', type:'재건축', district:'강남구', status:'진행중', year:'2026', scale:'5,808세대', role:'추진전략 수립',
      ...
      tasks:['재건축 추진전략 수립','정비계획 수립 및 변경 자문','안전진단 관련 행정 절차 지원','조합설립 동의서 징구 전략','사업성 분석 및 수지분석','서울시 신통기획 대응'],
    ...
    { id:'pf8', name:'장위4구역 주택재개발 정비사업', type:'재개발', district:'성북구', status:'진행중', year:'2025', scale:'2,840세대', role:'조합운영 지원',
      description:'서울 성북구 장위동 장위뉴타운 내 위치한 대규모 재개발 구역. 장위자이 레디언트 브랜드로 지하 3층~지상 31층, 31개동 2,840세대 규모의 단지가 조성된다. 당사는 조합설립 단계의 동의서 징구, 총회 운영, 이해관계 조율 등 조합운영 전반을 지원하고 있다.',
      featured:false,
      ...
      tasks:['조합설립인가 지원','동의서 징구 전략 수립 및 실행','총회·이사회 운영 지원','조합원 이해관계 조율','민원 대응 및 갈등 관리'],
