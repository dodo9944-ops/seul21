...
const MOCK = {
  ...
  library: [
    ...
    { id:'bid0409a', category:'입찰공고', title:'[입찰공고][성동구] 성수전략정비구역 4지구 재개발 시공자 선정 입찰', description:'성동구 성수전략정비구역 제4지구 재개발정비사업 시공자 선정 입찰공고. 일반경쟁입찰, 도급제 방식', fileType:'web', fileSize:'웹문서', date:'2026-04-09', downloads:0, tags:['성동구','성수4지구','시공자선정','재개발','입찰','2026-04-09'], bidDeadline:'2026-04-25', bidStatus:'진행중', bidType:'시공사', source:'서울시 정비사업 정보몽땅' },
    { id:'bid0409b', category:'입찰공고', title:'[입찰공고][서초구] 신반포20차 소규모재건축 정비사업전문관리업자 선정 입찰', description:'서초구 신반포20차아파트 소규모재건축 정비사업전문관리업자 선정 입찰공고', fileType:'web', fileSize:'웹문서', date:'2026-04-09', downloads:0, tags:['서초구','신반포20차','소규모재건축','정비업체','입찰','2026-04-09'], bidDeadline:'2026-04-22', bidStatus:'진행중', bidType:'정비업체', source:'나라장터(G2B)' },
    { id:'bid0409c', category:'입찰공고', title:'[입찰공고][양천구] 목동6단지 재건축 시공자 선정 입찰 마감 안내', description:'양천구 목동신시가지 6단지 재건축정비사업 시공자 선정 입찰 마감(4.10). 10개 건설사 참전', fileType:'web', fileSize:'웹문서', date:'2026-04-09', downloads:0, tags:['양천구','목동6단지','재건축','시공자선정','입찰마감','2026-04-09'], bidDeadline:'2026-04-10', bidStatus:'마감임박', bidType:'시공사', source:'하우징헤럴드' },
    { id:'ntc0409a', category:'관련판례', title:'[고시][국토교통부] 도시정비법 시행령 개정 세부규정 고시 — 재건축 패스트트랙 2026.6 시행', description:'국토교통부 고시. 도시정비법 시행령 개정안 세부규정 마련. 30년 이상 노후 건축물 안전진단 면제, 재건축진단 서류 재활용 허용. 2026년 6월 전면 시행', fileType:'web', fileSize:'웹문서', date:'2026-04-08', downloads:0, tags:['국토부','도시정비법','시행령개정','재건축패스트트랙','고시','2026-04-08'], url:'https://www.molit.go.kr', importance:'중요', issuer:'국토교통부', effectiveDate:'2026-06-01', noticeType:'고시' },
    { id:'ntc0409b', category:'관련판례', title:'[행정예고][서울시] 2026년 제2차 도시·주거환경정비기본계획 변경 행정예고', description:'서울시 행정예고. 도시·주거환경정비기본계획 변경안 — 신규 정비예정구역 12개소 추가 지정, 정비구역 해제 기준 개선', fileType:'web', fileSize:'웹문서', date:'2026-04-07', downloads:0, tags:['서울시','정비기본계획','행정예고','정비예정구역','2026-04-07'], url:'https://news.seoul.go.kr', importance:'중요', issuer:'서울특별시', effectiveDate:'2026-05-15', noticeType:'행정예고' },
    { id:'ntc0409c', category:'관련판례', title:'[입법예고][법제처] 공공주택특별법 시행규칙 일부개정령안 입법예고', description:'법제처 입법예고. 공공주택특별법 시행규칙 개정 — 도심복합사업 인허가 서류 간소화, 사전협의 절차 단축', fileType:'web', fileSize:'웹문서', date:'2026-04-06', downloads:0, tags:['법제처','공공주택특별법','입법예고','도심복합사업','2026-04-06'], url:'https://www.moleg.go.kr', importance:'일반', issuer:'법제처', effectiveDate:'2026-06-01', noticeType:'입법예고' }
  ],
