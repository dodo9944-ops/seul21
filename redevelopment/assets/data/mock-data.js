...
const MOCK = {
  ...
  companyInfo: {
    ceoName: '이창우',
    ceoTitle: '대표이사',
    ceoGreeting: '(주)세울엔지니어링은 재개발·재건축·소규모정비사업의 전 과정을 직접 수행하는 도시정비 전문 엔지니어링 회사입니다.\n\n사업성 검토, 인허가 대응, 조합 운영, 시공사 선정, 이해관계 조율은 물론, CM·PM 사업관리까지 정비사업에 필요한 모든 실무를 통합적으로 수행합니다.\n\n특히 가락현대5차 소규모재건축 정비사업에서는 소규모재건축 최초로 1군 시공사를 유치하고, 최단기간 5년 만에 입주를 완료하는 성과를 달성하였습니다. 이는 철저한 사업성 분석과 실행력 중심의 사업 관리가 만들어낸 결과입니다.\n\n세울엔지니어링은 각 사업장의 특성에 맞는 맞춤형 전략을 수립하고, 조합 운영의 투명성과 사업 추진의 안정성을 동시에 확보합니다.\n\n도시의 미래를 함께 세우는 신뢰할 수 있는 파트너가 되겠습니다.',
    history: [
