...
const MOCK = {
  ...
  faq: [
    ...
    { id:'f4', category:'투자', question:'비례율이 뭔가요?',
      answer:'비례율은 정비사업의 수익성을 나타내는 핵심 지표입니다. 계산식은 (종후자산 총액 - 총사업비) ÷ 종전자산 총액 × 100입니다. 100% 이상이면 조합원 분담금 없이 새 아파트를 받을 수 있다는 의미이며, 낮을수록 추가 분담금이 커집니다.' },
  ...
  library: [
    ...
    { id:'lib4', category:'법령', title:'도시 및 주거환경정비법 전문', description:'도시정비법 최신 개정본 (2026.1 시행)', fileType:'pdf', fileSize:'1.2MB', date:'2026-01-05', downloads:312, tags:['도정법','법령'] },
