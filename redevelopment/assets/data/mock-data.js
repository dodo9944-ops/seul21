...
const MOCK = {
  ...
  portfolio: [
    /* ===== 주요실적 (Featured) ===== */
    { id:'pf1', name:'가락현대5차 소규모재건축 정비사업', type:'소규모정비', district:'송파구', status:'진행중', year:'2026', scale:'179세대', role:'기본계획~준공 전과정 자문',
    ...
    { id:'pf2', name:'반포124주구 주택재건축 정비사업', type:'재건축', district:'서초구', status:'진행중', year:'2026', scale:'5,007세대', role:'공공관리·사업성분석 자문',
    ...
    { id:'pf3', name:'왕십리1구역 주택재개발 정비사업', type:'재개발', district:'성동구', status:'완료', year:'2015', scale:'1,702세대', role:'사업시행 자문',
    ...
    /* ===== 재개발 ===== */
    { id:'pf4', name:'미아3 재정비촉진구역 주택재개발 정비사업', type:'재개발', district:'강북구', status:'진행중', year:'2024', scale:'1,037세대', role:'사업시행·관리처분 자문',
    ...
    { id:'pf5', name:'용두4구역 주택재개발 정비사업', type:'재개발', district:'동대문구', status:'진행중', year:'2026', scale:'약 1,000세대', role:'사업시행·관리처분 자문',
    ...
    { id:'pf6', name:'마장1구역 주택재개발 정비사업', type:'재개발', district:'성동구', status:'진행중', year:'2026', scale:'262세대', role:'추진위 승인·사업성분석 자문',
    ...
    { id:'pf7', name:'휘경4구역 주택재개발 정비사업', type:'재개발', district:'동대문구', status:'완료', year:'2011', scale:'451세대', role:'사업시행 자문',
    ...
    { id:'pf8', name:'행당4구역 주택재개발 정비사업', type:'재개발', district:'성동구', status:'완료', year:'2017', scale:'465세대', role:'사업시행·관리처분 자문',
    ...
    { id:'pf9', name:'옥수13구역 주택재개발 정비사업', type:'재개발', district:'성동구', status:'완료', year:'2016', scale:'-', role:'사업시행 자문',
    ...
    { id:'pf10', name:'효창5구역 주택재개발 정비사업', type:'재개발', district:'용산구', status:'완료', year:'2009', scale:'-', role:'시공관리 자문',
    ...
    /* ===== 재건축 ===== */
    { id:'pf11', name:'면목1구역 주택재건축 정비사업', type:'재건축', district:'중랑구', status:'완료', year:'2020', scale:'167세대', role:'사업시행·관리처분 자문',
    ...
    /* ===== 소규모정비 ===== */
    { id:'pf12', name:'가락현대6차 가로주택정비사업', type:'소규모정비', district:'송파구', status:'진행중', year:'2025', scale:'191세대', role:'사업시행·관리처분 자문',
    ...
    { id:'pf13', name:'당산현대2차 소규모재건축사업', type:'소규모정비', district:'영등포구', status:'진행중', year:'2025', scale:'145세대', role:'사업시행·인허가 자문',
    ...
    { id:'pf15', name:'방배대우 가로주택정비사업', type:'소규모정비', district:'서초구', status:'진행중', year:'2025', scale:'136세대', role:'조합설립·사업시행 자문',
    ...
    { id:'pf16', name:'공덕현대 소규모재건축 정비사업', type:'소규모정비', district:'마포구', status:'진행중', year:'2025', scale:'232세대', role:'조합설립·사업시행 자문',
