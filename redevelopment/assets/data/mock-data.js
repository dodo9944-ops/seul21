...
const MOCK = {
  ...
  library: [
    ...
    { id:'lib21', category:'서식', title:'조합설립추진위원회 운영규정', description:'추진위 구성·운영·회의·재정·해산 전 과정 6장 25조 운영규정 전문', fileType:'pdf', fileSize:'75KB', date:'2026-04-04', downloads:0, tags:['추진위원회','운영규정','서식'] }
  ],
