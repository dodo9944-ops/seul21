...
const MOCK = {
  ...
  portfolio: [
    { id:'pf1', name:'한남3구역 주택재개발 정비사업', type:'재개발', district:'용산구', status:'진행중', year:'2026', scale:'5,816세대', role:'정비사업전문관리',
      description:'한남뉴타운 최대 규모 정비구역의 사업시행부터 관리처분까지 전 과정 관리',
      featured:true,
      thumbnail:'../assets/images/portfolio/hannam3.jpg',
      featuredImage:'../assets/images/portfolio/hannam3.jpg',
      detailImage:'../assets/images/portfolio/hannam3.jpg',
      imageAlt:'한남3구역 주택재개발 정비사업 조감도',
    ...
    { id:'pf2', name:'흑석9구역 주택재개발 정비사업', type:'재개발', district:'동작구', status:'진행중', year:'2025', scale:'3,446세대', role:'정비사업전문관리',
      description:'한강 조망 프리미엄 구역의 조합 운영 지원 및 시공사 선정 자문',
      featured:true,
      thumbnail:'../assets/images/portfolio/heukseok9.jpg',
      featuredImage:'../assets/images/portfolio/heukseok9.jpg',
      detailImage:'../assets/images/portfolio/heukseok9.jpg',
      imageAlt:'흑석9구역 디에이치 켄트로나인 조감도',
    ...
    { id:'pf3', name:'이문1구역 주택재개발 정비사업', type:'재개발', district:'동대문구', status:'진행중', year:'2025', scale:'4,321세대', role:'사업성분석·인허가',
      description:'래미안 라그란데 — 관리처분인가 단계 핵심 실무 및 분양설계 검토',
      featured:false,
      thumbnail:'../assets/images/portfolio/imun1.jpg',
      featuredImage:'../assets/images/portfolio/imun1.jpg',
      detailImage:'../assets/images/portfolio/imun1.jpg',
      imageAlt:'이문1구역 래미안 라그란데 조감도',
    ...
    { id:'pf4', name:'둔촌주공 재건축 정비사업', type:'재건축', district:'강동구', status:'완료', year:'2024', scale:'12,032세대', role:'사업관리 자문',
      description:'올림픽파크 포레온 — 국내 최대 규모 재건축 사업의 준공 단계 사업관리 자문',
      featured:true,
      thumbnail:'../assets/images/portfolio/dunchon.jpg',
      featuredImage:'../assets/images/portfolio/dunchon.jpg',
      detailImage:'../assets/images/portfolio/dunchon.jpg',
      imageAlt:'둔촌주공 올림픽파크 포레온 조감도',
    ...
    { id:'pf5', name:'은마아파트 재건축 추진', type:'재건축', district:'강남구', status:'진행중', year:'2026', scale:'5,808세대', role:'추진전략 수립',
      description:'안전진단 통과 후 정비계획 수립 및 조합설립 추진 지원',
      featured:false,
      thumbnail:'../assets/images/portfolio/eunma.jpg',
      featuredImage:'../assets/images/portfolio/eunma.jpg',
      detailImage:'../assets/images/portfolio/eunma.jpg',
      imageAlt:'은마아파트 재건축 배치도',
    ...
    { id:'pf6', name:'신길1구역 주택재개발 정비사업', type:'재개발', district:'영등포구', status:'진행중', year:'2024', scale:'1,483세대', role:'착공·시공관리',
      description:'힐스테이트 신길 클레온 — 착공 단계 시공관리 및 조합원 이주 지원 실무',
      featured:false,
      thumbnail:'../assets/images/portfolio/singil1.jpg',
      featuredImage:'../assets/images/portfolio/singil1.jpg',
      detailImage:'../assets/images/portfolio/singil1.jpg',
      imageAlt:'신길1구역 힐스테이트 신길 클레온 투시도',
    ...
    { id:'pf7', name:'성수동 가로주택 정비사업', type:'소규모정비', district:'성동구', status:'완료', year:'2025', scale:'120세대', role:'사업 전과정 관리',
      description:'가로주택정비사업 기획부터 준공까지 원스톱 관리 수행',
      featured:false,
      thumbnail:'../assets/images/portfolio/seongsu.jpg',
      featuredImage:'../assets/images/portfolio/seongsu.jpg',
      detailImage:'../assets/images/portfolio/seongsu.jpg',
      imageAlt:'성수동 가로주택 정비사업 현장',
    ...
    { id:'pf8', name:'장위4구역 주택재개발 정비사업', type:'재개발', district:'성북구', status:'진행중', year:'2025', scale:'2,840세대', role:'조합운영 지원',
      description:'장위자이 레디언트 — 조합설립 단계의 동의서 징구 및 총회 운영 지원',
      featured:false,
      thumbnail:'../assets/images/portfolio/jangwi4.jpg',
      featuredImage:'../assets/images/portfolio/jangwi4.jpg',
      detailImage:'../assets/images/portfolio/jangwi4.jpg',
      imageAlt:'장위4구역 장위자이 레디언트 조감도',
    ...
    { id:'pf9', name:'수색13구역 주택재개발 정비사업', type:'재개발', district:'은평구', status:'진행중', year:'2026', scale:'1,464세대', role:'정비구역 지정 지원',
      description:'DMC SK뷰 아이파크포레 — 기본계획 수립 및 정비구역 지정 관련 행정 절차 대응',
      featured:false,
      thumbnail:'../assets/images/portfolio/susaek13.jpg',
      featuredImage:'../assets/images/portfolio/susaek13.jpg',
      detailImage:'../assets/images/portfolio/susaek13.jpg',
      imageAlt:'수색13구역 DMC SK뷰 아이파크포레 조감도',
    ...
    { id:'pf10', name:'방배동 소규모재건축 정비사업', type:'소규모정비', district:'서초구', status:'완료', year:'2024', scale:'85세대', role:'사업 전과정 관리',
      description:'소규모재건축 사업 인허가 및 시공관리 전 과정 수행',
      featured:false,
      thumbnail:'../assets/images/portfolio/bangbae.jpg',
      featuredImage:'../assets/images/portfolio/bangbae.jpg',
      detailImage:'../assets/images/portfolio/bangbae.jpg',
      imageAlt:'방배동 소규모재건축 정비사업 현장',
      floorInfo:'지하2층 / 지상7층', floorAbove:7, floorBelow:2,
