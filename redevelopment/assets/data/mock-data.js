...
const MOCK = {
  ...
  community: [
    ...
    { id:'p18', title:'가로주택정비사업과 소규모재건축의 차이점이 뭔가요?', category:'질문',
      author:'동네개발관심', content:'저희 동네가 노후 빌라촌인데 가로주택정비사업과 소규모재건축 두 가지 방법이 있다고 들었습니다. 각각의 요건, 장단점, 층수 제한, 사업 기간 차이를 알고 싶습니다. 어떤 방식이 더 유리한지 판단 기준도 있을까요?',
  ...
  companyInfo: {
    ...
    businessAreas: [
      ...
      { id:'ba4', title:'가로주택 정비사업', icon:'fa-solid fa-drafting-compass', desc:'도시계획 수립, 정비구역 지정, 용도지역 변경 등 도시공간 재편을 위한 엔지니어링 서비스를 제공합니다.', details:'기초조사 → 도시계획 수립 → 도시계획위원회 심의 대응 → 정비구역 지정 고시 → 후속 인허가 연계' },
